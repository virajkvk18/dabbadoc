...
ADDITIVE_KB = {
    ...
    "sugar": {
        "name": "Sugar",
        "purpose": "sweetness, browning, texture, and quick taste appeal",
        "simple": "Sugar taste ko sweet banata hai but fullness nahi deta. Regular packaged sugar snacks se cravings aur calorie load badh sakta hai.",
        "concern": "high",
        "alternative": "Fruit, dates in small amount, or unsweetened versions.",
    },
    "liquid glucose": {
        "name": "Liquid Glucose",
        "purpose": "sweetener and texture support",
        "simple": "Ye added sugar ka form hai. Product ko soft/chewy/sweet banata hai.",
        "concern": "high",
        "alternative": "Unsweetened snack or fruit-curd bowl.",
    },
    "salt": {
        "name": "Salt / Sodium",
        "purpose": "taste, preservation, and flavour balance",
        "simple": "Salt taste strong banata hai. Packaged foods mein sodium easily zyada ho sakta hai.",
        "concern": "medium",
        "alternative": "Fresh herbs, lemon, roasted spices, lower-sodium options.",
    },
    "refined wheat flour": {
    ...
    "emulsifier": {
        "name": "Emulsifier",
        "purpose": "oil-water mix stable rakhna and smooth texture dena",
        "simple": "Emulsifier se product smooth/creamy aur stable dikhta hai. Concern usually processing level ka signal hota hai.",
        "concern": "low",
        "alternative": "Fresh homemade versions with curd, nuts, dal paste, or whole ingredients.",
    },
    "stabilizer": {
        "name": "Stabilizer",
        "purpose": "texture and consistency stable rakhna",
        "simple": "Stabilizer product ko same texture mein rakhta hai. Ye highly processed product ka signal ho sakta hai.",
        "concern": "low",
        "alternative": "Fresh/minimally processed option.",
    },
    "artificial flavour": {
        "name": "Artificial / Nature-Identical Flavour",
        "purpose": "flavour ko stronger and consistent banana",
        "simple": "Flavour product ko tasty banata hai. Main concern usually flavour alone nahi, full packaged-food pattern hota hai.",
        "concern": "medium",
        "alternative": "Natural spices, herbs, roasted garlic/onion, cocoa, fruit.",
    },
